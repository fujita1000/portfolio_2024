      ...
      <AnimatePresence>
        <motion.div className="w-screen h-screen relative" {...fadeIn}>
          <div className="z-[999] fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-popup_bg p-8 rounded-md shadow-lg w-[90%] h-[80%]">
            <div className="absolute top-0 left-0 w-[100%] h-[200px] xl:w-[75%] lg:h-[550px] xl:h-[100%] ">
            ...
            <div className=" w-[80%] h-[100%]"></div>             
               {showChatRoom ? (
                ...
                <div className="absolute right-[20px] top-[20px] xl:right-[30px] xl:top-[30px]">
                ...
                <div className="mt-[170px] lg:mt-[550px] xl:mt-[50px]">
                <ChatRoom postId={postId} />
                </div>
                </>
                ) : (
              <div className="text-white w-[99%] xl:w-[25%] ">
