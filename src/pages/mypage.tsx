...
const MyPage = () => {
  ...
  return (
    ...
    {isLoggedIn && (
    <div className='w-[1248px] h-[573px] m-auto bg-profile_bg my-[85px]'>
      <div className='w-[80%] m-auto h-[90%] py-[50px] relative'>
      <Profile />

      <div className="relative mt-[400px]">
      <button onClick={handleSignOut} className='w-[460px] h-[70px] bg-black absolute left-[0px]'>ログアウトする</button>
      <button onClick={handleDeleteAccount} className='w-[460px] h-[70px] bg-remove_bg absolute right-[0px]'>退会する</button>
      </div>
